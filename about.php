...
<div class = "mainBase">
	<div class = "centerDiv">
		...
		<div class = "headerDiv">
				<table>
				<tr>
						<img style="position: relative;top:0px;padding: 0px;" src="..networking.jpg" width="100%" height="100%">
					</td>
				</tr>
			</table>
		</div>
		...
		<img src="..supercomputers.jpg" width="100%" height="250px">
			<div id = "menu">
				<table>
				<tr>
				<p style="color: white" class = "topic" >Network Hardware and Peripherals</p>
					...
					<tr>
						<td><img src="..hub.gif" width="200px" height="auto"></td>
						<td>
					...
					<tr>
						<td><img src="..utp.jpg" width="200px" height="auto"></td>
						<td>
...
In contrast to shielded or foiled twisted pair (typically F/UTP or S/FTP cable shielding), UTP (unshielded twisted pair) cable is not surrounded by any shielding. UTP is the primary wire type for telephone usage and is very common for computer networking, especially as patch cables or temporary network connections due to the high flexibility of the cables.
					...
					<tr>
						<td><img src="..rj45.jpg" width="200px" height="auto"></td>
						<td>
					...
					<tr>
						<td><img src="..crimper.jpg" width="200px" height="auto"></td>
						<td>
	...
	<img src="..blugo.png" width="100%" height="100%">
			</div>
	</div>
</div>
</body>
